...
import PotentialDropDown from "./potential_dropdown";
export default function PotentialSelectBox({ title = "", value = "Tất cả" }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <PotentialDropDown valueSelect={valueSelect} setValueSelect={setValueSelect}/>}
      </span>
    </div>
  );
}
