...
export default function ThemPhieuChiKK() {
        ...
        <>
            <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-around" }}>
                <div className={styless.fieldsetne} >
                    ...
                    <div>
                        <InputText label="Số tiền cần thanh toán" placeholder="Nhập số tiền cần thanh toán" />
                ...
                <div className={styless.fieldsetne} >
                    ...
                    <div>
                        <InputText label="Số điện thoại" placeholder="Số điện thoại khách hàng" />
                    ...
                    <div className={styless.fieldsetne} >
                        ...
                        <div>
                            <InputText label="Số điện thoại người liên hệ" placeholder="Số điện thoại người liên hệ" />
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", gap: 50, paddingRight: 100 }}>
                <div className={styless.btn} >
                    <Button onClick={() => { setIsShowModalReturn(true) }} style={{ width: 200 }} className="btn btn-warning">Hủy</Button>

                </div>
                <Link href={"phieu-chi"} className={styless.btn}>
                    <Button style={{ width: 200 }} type="primary" className="btn btn-warning">Lưu</Button>
