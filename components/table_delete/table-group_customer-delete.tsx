...
const Table_GCustomer = (props: any) => {
    const { ColumGCustomer, dataPotential, name } = props;
    ...
    return (
        <div className={`${styles.main__content} ${styles.flex_column}`}>
            <div className={styles.main__control_search_delete}>
                <Input placeholder={`Tìm kiếm theo ${name.toLowerCase()}`}
                    suffix={suffix}
                    bordered={false}
                    style={{
...
export default Table_GCustomer;