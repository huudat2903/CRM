...
import CampaignDropDownDataStep from "./select_box_dropdown_data";
export default function CampaignSelectBoxStep({
  title = "",
  value = "Tất cả",
  placeholder = "",
  data = [],
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isOpen && <CampaignDropDownDataStep data={data} value={value}/>}
      </span>
    </div>
  );
}
