    ...
    <div ref={mainRef} className={styleHome.main}>
      <div className={styles.col}>
        ...
        <div className={styles.main_setting_body}>
          <Link className={styles.main_setting_item} href="/setting/sales_process">
            Quy trình bán hàng
          </Link>
        </div>
      </div>
      ...
      <div className={styles.col}>
        ...
        <div className={styles.main_setting_body}>
          ...
          <Link className={styles.main_setting_item} href="/setting/switch_board">
            Tổng đài điện thoại
          </Link>
        </div>
      </div>
      ...
      <div className={styles.col}>
        ...
        <div className={styles.main_setting_body}>
          <Link className={styles.main_setting_item} href="/setting/webform/list">
            Webform
          </Link>
        </div>
      </div>
      ...
      <div className={styles.col}>
        ...
        <div className={styles.main_setting_body}>
          <Link className={styles.main_setting_item} href="/setting/share_customer">
            Chia sẻ khách hàng
          </Link>
        </div>
      </div>
