    ...
    return (
        <>
            <Modal
                ...
                title={<div style={{ background: "blue", width: "111%", margin: "-20px -30px" }}><div style={{ color: "white", fontSize: 20, textAlign: 'center' }}>
                ...
                footer={[
                    <div key={"1"} style={{ display: "flex", justifyContent: "space-around", paddingLeft: 50 }}>
                        <Button style={{ width: 140, height: 36, border: "1px solid blue", color: "blue", fontSize: 16, fontWeight: 1000, }} key="back"
                            onClick={onClose}>
                            Hủy
                        </Button>
                        <Button key={"2"} style={{ width: 140, height: 36, background: "blue", fontSize: 16, fontWeight: 1000 }} type="primary"
