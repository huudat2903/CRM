...
import { Columbill } from "../../../components/delete_data/colums_field/bill";
import { dataPotential } from "../../../components/delete_data/colums_field/data"
import Table_Bill from "@/components/table_delete/table-bill-delete";
export default function Bill_List_Delete() {
  ...
  useEffect(() => {
    setHeaderTitle("Dữ liệu đã xoá / Hoá đơn");
