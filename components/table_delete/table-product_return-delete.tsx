...
const Table_Product_Return = (props: any) => {
    const { ColumProductReturn, dataPotential, name } = props;
    ...
    const columns = ColumProductReturn
    ...
    return (
        <div className={`${styles.main__content} ${styles.flex_column}`}>
            <div className={styles.main__control_search_delete}>
                <Input placeholder={`Tìm kiếm theo số đề nghị, khách hàng`}
                    suffix={suffix}
                    bordered={false}
                    style={{
                        width: "100%", fontSize: 20, fontWeight: 1000,
                        textAlign: "center",
                        height: "100%"
                    }}
                />
            ...
            <div className={styles.table}>
                <div style={{ marginBottom: 16 }} className={styles.selected}>
                    ...
                    {hasSelected ? <Button style={{ color: "red" }} type="link" onClick={start} >
                        Bỏ chọn
                    </Button> : <Button type="link" onClick={selectAll} >
                        Chọn tất cả
                    </Button>}
...
export default Table_Product_Return;