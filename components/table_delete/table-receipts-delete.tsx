...
const Table_Receipts = (props: any) => {
    const { ColumReceipts, dataPotential, name } = props;
    ...
    return (
        <div className={`${styles.main__content} ${styles.flex_column}`}>
            <div className={styles.main__control_search_delete}>
                <Input placeholder={`Tìm kiếm theo số phiếu, tên phiếu thu`}
                    suffix={suffix}
                    bordered={false}
                    style={{
