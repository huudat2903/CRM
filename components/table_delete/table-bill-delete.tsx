...
const Table_Bill = (props: any) => {
  const { Columbill, dataPotential, name } = props;
  ...
  const columns = Columbill;
  const isviewPageSize = isMobile();
  ...
  return (
    <div className={`${styles.main__content} ${styles.flex_column}`}>
      <div className={styles.main__control_search_delete}>
        <Input
          placeholder={`Tìm kiếm theo tên đề nghị, khách hàng`}
          suffix={suffix}
          bordered={false}
          style={{
            width: "100%",
