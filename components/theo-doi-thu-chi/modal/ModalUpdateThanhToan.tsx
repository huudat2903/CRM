    ...
    return (
        <div>
            <Modal
                width={530}
                open={isShowModal}
                title={<div style={{ background: "blue", width: "111%", margin: "-20px -24px" }}>
                ...
                footer={[
                    <div key={"1"} style={{ display: "flex", justifyContent: "center", gap: 20 }}>
                        <Button style={{
                            width: 140, height: 36, border: "1px solid blue", color: "blue",
                            fontSize: 16, fontWeight: 1000
                        }} key="back" onClick={onClose}>
                            Hủy
                        </Button>
                        <Button key={"2"} style={{ width: 140, height: 36, background: "blue", fontSize: 16, fontWeight: 1000 }}
                            type="primary"
                            loading={loading} >
                            Cập nhật
                        </Button>,
