  ...
  return (
    <div>
      ...
      <div style={{float:"right"}}>
        <Button onClick={()=>{alert("Gửi câu trả lời thành công, cảm ơn bạn đã đánh giá"),router.push("/khao-sat")}} style={{width:200,color:"blue",border:"1px solid blue"}}> Gửi</Button>
      </div>
   </div>
  );
}
