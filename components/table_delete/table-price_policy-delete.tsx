...
const Table_Price_Policy = (props: any) => {
    const { ColumPricePolicy, dataPotential, name } = props;
    ...
    const columns = ColumPricePolicy
    ...
    return (
        <div className={`${styles.main__content} ${styles.flex_column}`}>
            <div className={styles.main__control_search_delete}>
                <Input placeholder={`Tìm kiếm theo tên ${name.toLowerCase()}`}
                    suffix={suffix}
                    bordered={false}
                    style={{
...
export default Table_Price_Policy;